...
\RUNTITLE{Solving RO Models using a conic program solver}
...
\ARTICLEAUTHORS{%
\AUTHOR{Yuan Gao}
\AFF{Department of Mathematics, National University of Singapore, Science Drive 2, Singapore, 119224, \EMAIL{gaoyuan@u.nus.edu}} %, \URL{}}
} % end of the block
...
\KEYWORDS{robust optimization, exponential cone, conic programming}
...
that there isn't good butter research going on out there.  Many
researchers
...
retrieval dates for website citations, publication year and volume
