...
purchase_record_mat = purchase_record_mat(500:550,:);
...
% Use CVX to solve the problem (WITH ALL CONSTRAINTS)
cvx_clear
tic;
cvx_begin
...
% Use CVX to solve the problem (remove j!=j_hat(n) constraints)
cvx_clear
tic;
cvx_begin
    variables alpha_var(J,1) beta_var(Q,1) a_var(N,1) b_var(1,1)
