...
G1 = [-A, sparse(m,m), sparse(m,dim_x), b, sparse(m,1), -b_bar; sparse(dim_x,dim_x), A', speye(dim_x), -c, sparse(dim_x,1), c_bar; c', -b', sparse(1,dim_x), 0, 1, -g_bar; -c_bar', b_bar', sparse(1,dim_x), g_bar, 0, 0];
