...
\section{Modeling with the exponential cone}
In this section we duscuss several applications of the exponential cone. Specifically, may problems that arise from stochastic and robust optimization can be formulated into (PD) with exponential cone constraints.
\subsection{Portfolio optimization based on satisficing measure}

\subsection{Convex approximation of chance constrained problems}

\subsection{Maximum likelihood estimation in customer choice model}
