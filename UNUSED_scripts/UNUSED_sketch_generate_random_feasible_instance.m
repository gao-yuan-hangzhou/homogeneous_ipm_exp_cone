blk{1,1} = 'e'; blk{1,2} = [3;3;3;3];
blk{2,1} = 'l'; blk{2,2} = 50;
blk{3,1} = 'u'; blk{3,2} = 2; 
blk{4,1} = 'l'; blk{4,2} = 137;
blk{5,1} = 'q'; blk{5,2} = [3;4;3;5;6;7;8;4;100];
blk{6,1} = 'e'; blk{6,2} = 3*ones(55,1);
m = 170;
